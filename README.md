...
```
dotnet ef database update --project src/CreateInvoiceSystem.Persistence/CreateInvoiceSystem.Persistence.csproj --startup-project src/CreateInvoiceSystem.API/CreateInvoiceSystem.API.csproj
```
...
Przykład:
```
dotnet run --project ./src/CreateInvoiceSystem.Persistence.Seed.Mock -cs "Server=localhost,1433;Database=CreateInvoiceSystemDb;User Id=sa;Password=SuperSecretPass!234;TrustServerCertificate=True;"
```
