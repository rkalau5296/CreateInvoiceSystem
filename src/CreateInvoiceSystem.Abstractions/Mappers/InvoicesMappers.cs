...
public static class InvoiceMappers
{
    public static InvoiceDto ToDto(this Invoice Invoice) =>
        new(Invoice.InvoiceId, Invoice.Title, Invoice.Value, Invoice.PaymentDate, Invoice.CreatedDate, Invoice.Comments, Invoice.ClientId, Invoice.UserId, Invoice.ProductId, Invoice.Product.ToDto(), Invoice.Client.ToDto(), Invoice.User.ToDto());
