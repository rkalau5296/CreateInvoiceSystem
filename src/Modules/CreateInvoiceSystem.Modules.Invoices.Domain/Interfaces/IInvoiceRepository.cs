...
public interface IInvoiceRepository : ISaveChangesContext
{
    ...
    Task<int> GetMaxInvoiceNumberInMonthAsync(int userId, int month, int year, CancellationToken ct);
    Task RemoveAllByUserIdAsync(int userId, CancellationToken ct);
}
